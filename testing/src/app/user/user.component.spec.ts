...
describe('Component: User', () => {
  ...
  it('should\'t fetch data successfully if not called asynchronously', () => {
    ...
    let spy = spyOn(dataService, 'getDetails').and.returnValue(Promise.resolve('FakeData'));
    fixture.detectChanges();
